                    ...
                    <div className="md:w-1/2 bg-white shadow-md lg:rounded-l-2xl h-full mx-4 lg:mx-0 p-8 overflow-y-auto">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                            ...
                            <LabelInputContainer>
                                ...
                                />
                                {errors.identifier?.message && <p className="text-red-500 text-md mt-2">{errors.identifier.message}</p>}
                            </LabelInputContainer>
                        ...
                        <div className="flex md:flex-row flex-col gap-4">
                            <div className="relative w-full">
                                ...
                                {openDropdown === "lender" && (
                                    <div className="absolute left-0 right-0 flex flex-col bg-white border border-gray-200 rounded-md mt-1 shadow-lg z-10">
                                        <Link href="/register/lender/individual" className="px-4 py-2 hover:bg-blue-50">Individual</Link>
                                        <Link href="/register/lender/organization" className="px-4 py-2 hover:bg-blue-50">Organization</Link>
                                        <Link href="/register/lender/nri" className="px-4 py-2 hover:bg-blue-50">NRI</Link>
                                        <Link href="/register/lender/huf" className="px-4 py-2 hover:bg-blue-50">HUF</Link>
                                    </div>
                                )}
                            </div>
                            ...
                            <div className="relative w-full">
                                ...
                                {openDropdown === "borrower" && (
                                    <div className="absolute left-0 right-0 flex flex-col bg-white border border-gray-200 rounded-md mt-1 shadow-lg z-10">
                                        <Link href="/register/borrower/personal" className="px-4 py-2 hover:bg-green-50">Personal</Link>
                                        <Link href="/register/borrower/business" className="px-4 py-2 hover:bg-green-50">Business</Link>
                                    </div>
                                )}
                            </div>
                        </div>
