            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
                ...
                <div className="relative overflow-hidden min-h-[300px] lg:min-h-screen order-2 lg:order-1">
                    ...
                    <div className="relative z-10 p-6 lg:p-16 text-white">
                        ...
                        <h2 className="text-3xl lg:text-5xl font-bold leading-tight mb-4">Access your account</h2>
                        <p className="max-w-md text-primary-foreground/80 text-sm lg:text-base">Manage your loans, check application status, and more.</p>
                    </div>
