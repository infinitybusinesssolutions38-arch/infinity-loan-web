  ...
  return (
    ...
    >
        ...
        <div className="space-y-4">
          <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            <div className="flex items-start gap-3">
              <span className="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-[#E6F7FD]">
                ...
                >
                  <div className="flex items-start gap-3">
                    <span className="mt-0.5 inline-flex h-9 w-9 items-center justify-center rounded-lg bg-white">
                      <item.icon className="h-5 w-5 text-[#008FCC]" />
                    </span>
                    <div>
          ...
          <div className="rounded-2xl border border-[#E6F7FD] bg-gradient-to-br from-[#E6F7FD] to-white p-6 shadow-sm">
            <div className="flex items-start justify-between gap-4">
              ...
              <Landmark className="h-6 w-6 text-[#008FCC]" />
            </div>
            <div className="mt-5 flex flex-col gap-3 sm:flex-row">
              <Link
                href="/contact"
                className="inline-flex h-11 w-full items-center justify-center rounded-xl bg-[#00AEEF] px-5 text-sm font-semibold text-white shadow-sm transition hover:bg-[#008FCC] sm:w-auto"
              >
                Talk to an expert
              </Link>
              <Link
      ...
      <section className="mt-10 grid gap-6 lg:grid-cols-3">
        <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
          <div className="flex items-center gap-2">
            <ListChecks className="h-5 w-5 text-[#008FCC]" />
            <h2 className="text-base font-semibold text-gray-900">
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
          <div className="flex items-center gap-2">
            <FileText className="h-5 w-5 text-[#008FCC]" />
            <h2 className="text-base font-semibold text-gray-900">
              Documentation
            </h2>
          </div>
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
          <div className="flex items-center gap-2">
            <BadgeCheck className="h-5 w-5 text-[#008FCC]" />
          ...
          <div className="mt-5 space-y-3">
            <Link
              href="/register"
              className="inline-flex h-11 w-full items-center justify-center rounded-xl bg-[#00AEEF] px-5 text-sm font-semibold text-white shadow-sm transition hover:bg-[#008FCC]"
            >
              Apply now
            </Link>
            <Link
      ...
      <section className="mt-10 rounded-3xl border border-gray-200 bg-white p-6 shadow-sm sm:p-8">
        <div className="flex items-start gap-3">
          <span className="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-[#E6F7FD]">
            <HelpCircle className="h-5 w-5 text-[#008FCC]" />
          </span>
          <div>
