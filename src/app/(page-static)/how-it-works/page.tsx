    ...
    return (
        <section className="w-full pt-5">
            <div className="mx-6 md:mx-auto md:w-[70%] mt-4 md:mt-10 mb-3">
                <div>
                    <h3 className="text-2xl font-bold border-b-2">How Infinity Loans Works</h3>
                    <ul className='ml-2 mt-1'>
                        <li className='mb-5 list-disc '>
                            Infinity Loans is India&apos;s first peer-to-peer (P2P) lending platform to receive a Certificate of Registration (CoR) as an NBFC-P2P from the Reserve Bank of India (RBI). Our mission is to provide a marketplace that connects individuals in need for credit with individuals and institutes willing to lend their access funds. We use technology to speed up the process and cut costs. Thus, we provide an opportunity to the borrowers to get their requirements funded at viable rates and help lenders get the best possible return on their investment.
                        </li>
                ...
                <div className='my-3'>
                    ...
                    <ul className='ml-4' >
                        <li className='mb-3 list-decimal'>
                            On Infinity Loans, visitors, as per their requirement, can register as lenders or borrowers. Infinity Loans undertakes a comprehensive verification process based on personal, financial and professional information provided of all its registered Borrowers and Lenders.
                        </li>
                        <li className='mb-3 list-decimal'>
                        ...
                        <li className='mb-3 list-decimal'>
                            Repayment can be done through an online, automated process and tracked via their unique account on www.infinityloanservices.com. Infinity Loans provides a fair, transparent, technology-driven platform for the whole process to happen smoothly and quickly.
                        </li>
                        <li className='mb-3 list-decimal'>
                            So go on and SIGN UP now to try out this new business opportunity because every % counts!
                        </li>
