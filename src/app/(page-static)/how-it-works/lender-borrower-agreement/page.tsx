    ...
    return (
        <section className="w-full pt-5">
            <div className="mx-6 md:mx-auto md:w-[70%] mt-4 md:mt-10 mb-3">
                <div>
                    <h3 className="text-2xl font-bold border-b">Lender - Borrower Loan Agreement</h3>
                    <p className='mp-3'>
                        This Lender - Borrower Loan Agreement (the "Agreement") shall govern the terms and conditions applicable to the Loan
