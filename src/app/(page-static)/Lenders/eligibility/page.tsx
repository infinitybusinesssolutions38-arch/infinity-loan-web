            ...
            <div className="mx-6 md:mx-auto md:w-[70%] mt-4 md:mt-10 mb-3">
                ...
                <div>
                    ...
                    <ul className='ml-6'>
                        ...
                        <li className='list-disc'>Agree to abide byInfinity Loans Policies.</li>
