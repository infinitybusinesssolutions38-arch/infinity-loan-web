...
const Page = () => {
  ...
  const checkUser = async () => {
    try {
      ...
      if (user.role === "lender-organization") {
      ...
      <main className="min-h-screen bg-background">
        <section className="relative overflow-hidden bg-gradient-to-br from-primary via-primary/90 to-primary/80 py-10">
          ...
          <div className="container relative z-10 mx-auto px-4">
            <h3 className="mt-0 text-center font-bold text-3xl text-primary-foreground">
              Organization Lender Dashboard
            </h3>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="rounded-2xl border border-border bg-card p-6 shadow-lg">
              <p className="text-md font-medium text-foreground">
                Welcome, Organization Lender! You can view and manage borrowers here.
              </p>
