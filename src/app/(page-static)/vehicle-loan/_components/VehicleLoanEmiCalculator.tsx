  ...
  return (
    <section className="rounded-2xl border border-gray-100 bg-white p-5 shadow-sm sm:p-6">
      <div className="flex flex-col gap-2">
        <h3 className="text-lg font-semibold text-gray-900">Vehicle Loan EMI Calculator</h3>
        <p className="text-sm text-gray-600">
          Estimate your monthly EMI for a car, bike, or commercial vehicle loan.
        </p>
      </div>
      ...
      <div className="mt-4 rounded-xl border border-blue-100 bg-blue-50 px-4 py-3">
        <p className="text-xs text-blue-900">
          Indicative calculation. Actual EMI may vary based on lender fees and the final sanctioned interest rate.
        </p>
      </div>
    </section>
  );
