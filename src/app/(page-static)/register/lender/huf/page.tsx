...
const OrganizationSignupForm = () => {
    ...
    const onSubmit = async (data: OrgFormData) => {
        try {
            const res = await axios.post("/api/huf-loan", data);
            ...
            <div className="flex flex-col md:flex-row rounded-2xl overflow-hidden w-full max-w-6xl">
                ...
                <div className="md:w-1/2 bg-white shadow-md rounded-l-2xl p-8 overflow-y-auto">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        {/* Firm Name */}
                        <LabelInputContainer>
                            <Label htmlFor="firmName">Name of the HUF</Label>
                            <Input
                                id="firmName"
                                type="text"
                        ...
                        <div className="flex flex-col md:flex-row md:space-x-2">
                            <LabelInputContainer>
                                <Label htmlFor="panTan">PAN of HUF</Label>
                                <Input
                                    id="panHuF"
                                    type="text"
                            ...
                            <LabelInputContainer>
                                <Label htmlFor="cin">PAN of Karta</Label>
                                <Input
                                    id="cin"
                                    type="text"
                        ...
                        <div className="flex flex-col md:flex-row md:space-x-2">
                            <LabelInputContainer>
                                <Label htmlFor="directorFirstName">Karta First Name</Label>
                                <Input
                            ...
                            <LabelInputContainer>
                                <Label htmlFor="directorLastName">Karta Last Name</Label>
                                <Input
                                    id="directorLastName"
                                    type="text"
                                    placeholder="Doe"
