...
const createTransporter = () => {
    ...
    const port = parseInt(
        process.env.EMAIL_SMTP_PORT || process.env.EMAIL_smtp_PORT || process.env.EMAIL_PORT || "465",
        10
    );
    ...
    if (!user || !pass) {
        throw new Error(
            "Email transporter is not configured. Missing SMTP credentials (set EMAIL_SMTP_USER/EMAIL_SMTP_PASS or EMAIL_USER/EMAIL_PASS)."
        );
    }
...
export const sendLoanApplicationConfirmationEmail = async (
    ...
    <!-- YOUR FULL HTML EXACTLY SAME AS YOU SENT -->
      ...
      <head>
        ...
        <style>
          ...
          .highlight { background: linear-gradient(135deg, #fff4e6 0%, #ffe8cc 100%); padding: 25px; border-left: 4px solid #00AEEF; border-radius: 8px; margin: 25px 0; }
          .highlight h3 { margin-top: 0; color: #00AEEF; font-size: 18px; }
        ...
        <div class="container">
          ...
          <div class="section">
            ...
            <div class="contact-box">
              <ul>
                <li><strong>Phone/WhatsApp:</strong> +91 90283 46300</li>
                <li><strong>Email:</strong> business@infinityloanservices.com | personal.infinityloans@gmail.com</li>
          ...
          <div class="footer">
            <p><strong>📞 Customer Support:</strong> +91 90283 46300</p>
            <p><strong>📧 Email:</strong> business@infinityloanservices.com | personal.infinityloans@gmail.com</p>
    ...
    `;
        ...
        await transporter.sendMail({
            from: `"Infinity Loans & Business Solutions" <${
