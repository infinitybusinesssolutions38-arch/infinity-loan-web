    ...
    return (
        <div className="flex flex-col min-h-screen bg-white">
            ...
            <div className="flex-1 grid grid-cols-1 lg:grid-cols-2">
                ...
                <div className="relative bg-gradient-to-br from-gray-800 via-gray-900 to-black flex flex-col justify-center items-start p-8 lg:p-16 min-h-[500px] lg:min-h-screen">
                    ...
                    <div className="relative z-10 text-white">
                        <p className="text-lg font-semibold uppercase tracking-wider mb-4 text-[#33C1F3]">
                            APPLY FOR A LOAN
                        </p>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full px-4 py-3 border border-gray-300 rounded-lg bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#00AEEF] focus:border-transparent transition-all"
                                >
                            ...
                            <div>
                                ...
                                <Input
                                    ...
                                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00AEEF] focus:border-transparent transition-all"
                                />
                                {errors.mobile && (
                            ...
                            <div className="flex items-start gap-3 py-4">
                                ...
                                <label htmlFor="terms" className="text-sm text-gray-600">
                                    ...
                                    <a href="#" className="text-[#00AEEF] hover:underline font-semibold">
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full bg-[#00AEEF] hover:bg-[#008FCC] text-white font-bold py-3 px-4 rounded-lg transition-all duration-300 disabled:bg-gray-400 disabled:cursor-not-allowed mt-6"
                            >
            ...
            <footer className="bg-gray-900 text-gray-400 py-8 px-6 text-center text-sm">
                <p>© 2026 Infinity Loans & Business Solutions. All rights reserved. | Privacy Policy | Terms & Conditions</p>
            </footer>
        </div>
    );
};
