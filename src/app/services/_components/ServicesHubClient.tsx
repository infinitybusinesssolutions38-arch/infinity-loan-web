...
const SERVICES: Record<HubCategoryKey, ServiceCardItem[]> = {
  ...
  "credit-cards": [
    ...
    },
    {
      ...
      description: "Instant overdraft/credit line based on your card eligibility and profile.",
    ...
    },
    {
      ...
      description: "Convert your card limit into a personal loan with fixed EMIs (subject to eligibility).",
    ...
    },
    {
      ...
      description: "Transfer outstanding balances to lower interest/introductory rate cards (subject to issuer policy).",
  ...
  items: [
    ...
    ...makeItems({
      ...
      titles: [
        ...
        "Loan Against Property (if salaried)",
  ...
  items: [
    ...
    ...makeItems({
      ...
      titles: [
        ...
        "Subsidiary Company Loan",
        "Associate Company Loan",
        "Joint Venture (JV) Company Loan",
        "Foreign Company / Indian Subsidiary Loan",
        "Special Purpose Vehicle (SPV) Company Loan",
        "Corporate Working Capital Loan",
        "Corporate Overdraft / Cash Credit Facility",
        "Balance Sheet Based Loan",
        "Turnover Based Loan",
        "Trader Loan",
        "Wholesale Trade Loan",
        "Wholesaler Loan",
        "Distributor Loan",
        "Dealer Loan",
        ...
        "Textile & Garment Loan",
        "Chemical & Pharma Industry Loan",
        "Steel & Foundry Loan",
        "Construction & Infrastructure Company Loan",
...
const GOVT_SCHEME_SERVICES: ServiceGroup = {
  ...
  items: [
    ...
    },
    {
      ...
      title: "Maha Udyog",
      description:
        "End-to-end financing support for central and state government schemes including subsidies, term loans, and working capital assistance.",
...
const BUILDER_DEVELOPER_SERVICES: ServiceGroup = {
  ...
  items: [
    ...
    ...makeItems({
      ...
      infoHref: "/business-loan",
      titles: [
        "Builder & Developer Project Finance",
        "Residential / Commercial Project Finance",
