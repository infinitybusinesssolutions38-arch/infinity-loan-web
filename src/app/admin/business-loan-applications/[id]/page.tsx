...
export default function AdminBusinessLoanApplicationDetailPage({ params }: { params: { id: string } }) {
  ...
  const businessName = item.fullName || item.businessName || "-";
      ...
      <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
        <div>
          ...
          <div className="mt-1 text-sm text-muted-foreground">
            Business Loan • Ref: {item.applicationRef || "-"}
          </div>
        </div>
